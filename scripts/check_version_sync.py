...
TOUCHPOINTS: list[tuple[str, str, str, int]] = [
    ...
    ("Cargo.toml", "workspace dependency pins", r'\{ version = "@V@", path = ', 2),
    ...
    if previous is not None and previous != version:
        ...
        if lock is not None:
            for block in lock.split("[[package]]"):
                if re.search(r'(?m)^name = "wickra-backtest', block) and re.search(
